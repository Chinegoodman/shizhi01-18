/**
 * Created by 73142 on 2016/12/31.
 */
...
function lis_sendmsg_btn() {
    $('.right_audio_connectcontents_sendmsg').click(function () {
...
function supportbtnclick() {
    var supportbtncolor=0;
    $('.index_artical_details_support').hover(
        function () {
            $(this).addClass('active');
            $(this).children('.index_artical_details_support_btn').attr('src', '../imgages/support.png');
            $(this).click(function () {
                if (supportbtncolor==1){
                    supportbtncolor=0;
                }else{
                    supportbtncolor=1;
                }
            ...
            if (supportbtncolor==0){
                $(this).removeClass('active');
                $(this).children('.index_artical_details_support_btn').attr('src', '../imgages/nosupport.png');
            }else {
                $(this).addClass('active');
            }
        }
